...
from .views import HomeView,NoteCreateView, NoteListView, NoteDetailView, TripCreateView,TripDetailView,NoteUpdateView,NoteDeleteView,TripUpdateView,TripDeleteView,trips_list
urlpatterns = [
